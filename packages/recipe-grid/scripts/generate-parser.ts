 ...
 * built from units.ts. Names are not transcribed. parse-ingredient owns
 * the vocabulary.  Vaules are substituted in peggy on the resulting grammar,
 * writing the committed parser + types.
 */

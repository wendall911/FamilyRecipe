...
export type StartRuleNames = "Recipe";
export interface ParseOptions<T extends StartRuleNames = "Recipe"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Recipe">>(
  input: string,
  options?: Options,
): any;
